...
The purpose of this practical is to teach you common bio-informatics analyses performed to analyse epigenomics data. You may already be familiar with the output of these analyses from scientific publications or lectures. We will focus on **how to detect, quantify, annotate and visualise histone tail modifications**. Althought the majority of the tutorial focusses on the analysis of ChIP-seq data, you will also use RNA- and DNaseI-seq incidentally. In week 4, you will relate epigenetic markings to gene activity as well as candidate TFs that might establish them.  

For this practical, you will use **data of white blood cells** from the [the BLUEPRINT project](http://dcc.blueprint-epigenome.eu/#/home), these can be: monocytes, T cells, B cells and natural killer cells. We have chosen these datasets because they are well-documented and easy to find through the BLUEPRINT data portal, and not because we want to teach you the hematopoietic system.  
<br>  
...
> #### Background box:  
> For detailed discussion on FASTQC reports see the FASTQC website of the Babraham institute, and their tutorial on Quality Control in Sequencing Experiments [ref](https://www.bioinformatics.babraham.ac.uk/training.html#sequenceqc).  
...
<br>
Each record minimally holds 11 columns (additional columns can be added by the aligner and post-alignment analytics performed on the file):  
...
<br>
<details><summary>Read depth stored as a bedGraph file:</summary>  
...
An example:  
![](images/wk1_3_bedgraph_format_bedgraph.png){width=80%}    
Further reading: The UCSC Genome browser documentation on [bedGraph](https://genome.ucsc.edu/goldenPath/help/bedgraph.html), [wiggle](https://genome.ucsc.edu/goldenPath/help/wiggle.html) and [bigWig](https://genome.ucsc.edu/goldenPath/help/bigWig.html) file formats.  
</details> 
<br>
...
<br>
Alternatively, you can also intersect the read depth reported in the .bigWig files of step (5.) with the peak files from step (6.). This is what you will do in week 3.  
<br>
...
> <span style="color: black; font-family: Arial; font-size:14px;">**Action**: Go to the [UCSC Genome Browser](https://genome.ucsc.edu/index.html) (blue text is a link, use right-mouse click to open in new window).</span>   
...
> <span style="color: black; font-family: Arial; font-size:14px;">**Action**: To access the human genome, select the "Genomes" tab.</span>  
...
> <span style="color: black; font-family: Arial; font-size:14px;">**Action**: Ensure that "Human" is selected in the REPRESENTED SPECIES tree and "Dec. 2013 (GRCh38/hg38)" is selected under Human Assembly (red arrows in image below).</span>   

> <span style="color: black; font-family: Arial; font-size:14px;">**Action**: Go to *ACTB* gene (gene coding for non-muscular actin part of cytoskeleton).</span> 
...
> <span style="color: black; font-family: Arial; font-size:14px;">**Action**: hide all tracks and tracksets except for the ruler and GENCODE v32 tracks.</span>   

> <span style="color: black; font-family: Arial; font-size:14px;">**Action**: for GENCODE v32, via "Configure GENCODE v32", make sure the option "splice variants" is unchecked.</span>     
...
> <span style="color: black; font-family: Arial; font-size:14px;">**Action**: Go to the gene *SPI1* </span>    
...
> <span style="color: black; font-family: Arial; font-size:14px;">**Action**: Upload the required data using the following URL and return back to the Genome Browser:</span> `http://mbdata.science.ru.nl/ctoenhake/edu/trackhub_monocytes/hub.txt`.       
...
<br>
`r colorize("Auto-scaling", col = "red")`  
...
> <span style="color: black; font-family: Arial; font-size:14px;">**Action**: Go back to the *ACTB* locus </span>  
...
> <span style="color: black; font-family: Arial; font-size:14px;">**Action**: From the *ACTB* locus, zoom out 3x to see the surrounding region.</span>     
...
> <span style="color: black; font-family: Arial; font-size:14px;">**Action**: Turn the display of all peak tracks to "dense" using the drop-down menu.</span>    

> <span style="color: black; font-family: Arial; font-size:14px;">**Action**: From *ACTB* locus, zoom out 100x. A prominant H3K27me3 peaks upstream of *ACTB* comes in view.  </span>     
...
> <span style="color: black; font-family: Arial; font-size:14px;">**Action**: Navigate and zoom-out to chr5:140250000-141720000 .</span>    
...
> <span style="color: black; font-family: Arial; font-size:14px;">**Action**: Which of the following genes is silenced by H3K27me3? *ACTA1*,  *EED*, *GATA3*, *HDAC1*, *MYOD1* andncoding muscular actin.</span>  
...
> <span style="color: black; font-family: Arial; font-size:14px;">**Action**: upload the following track hub </span> `http://mbdata.science.ru.nl/ctoenhake/edu/trackhub_unknown/hub.txt`.
