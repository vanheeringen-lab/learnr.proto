...
> Refreshers, background information, tips and hints are often formatted in gray boxes and are not obligatory. 

- Background information can also be collapsed and recognized by black arrowheads:    
...
<br>
To upload the data we have already put them together in a so-called track hub, hosted by our own server. We can add this to our browser session by going to the tab "My Data" in the top menu and select "Track Hubs". In the "My hubs" tab you can paste a URL that directs to the data you want to upload. These screenshots show you where to be:   
<br>
<span style="color: goldenrod; font-family: Arial; font-size:16px;">**Action**: Upload the required data using the following URL</span> `http://mbdata.science.ru.nl/ctoenhake/edu/trackhub_monocytes/hub.txt`. <span style="color: goldenrod; font-family: Arial; font-size:16px;"> And return back to the Genome Browser.</span>     
<br>  
...
question("What is the name of this trackhub",
          ...
          answer("BLUEPRINT monocytes", correct = TRUE, message = "You might notice the 'hidden' peak tracks, we will use them in part 1.4.4."),
...
quiz(""
  ...
  question("B.) If you would only have ChIP-seq data, which track do you need to answer (A.)?",
         ...
         answer("monocyte_H3K36me3", correct = TRUE),
         allow_retry = TRUE)
)
...
<br>
```{r q10_ACTB_DNaseIseq, echo = F}
question("Which of the following regions points to a DNaseI-seq peak?",
  answer("chr7:5531001-5532001", message = "Nice try but this region has a H3K4me3 peak."),
  ...
  answer("None of the these", message = "Look again, one of these regions covers a DNaseI-peak. You can hold shift+click and drag with your mouse to highlight the approximate areas."),
  allow_retry = TRUE
     )
```

```{r q11_ACTB_histone_marks_one, echo = F}
question("We define the promoter as 3kb upstream of the TSS. Which histone marks are detected at the ACTB promoter? (Select ALL that apply)",
...
```{r q12_FSCN1_bivalent_promoter, echo = F}
question("The promoter of which gene is covered by this mark?)",
...
<span style="color: goldenrod; font-family: Arial; font-size:16px;">**Action**: Zoom into that gene *including* the prominant H3K27me3 peak.</span>     

> #### **Optional check**:  
<details><summary> Your browser should be showing *at least*:</summary>  
<br>
chr7:5,589,700-5,607,000 or a few 100 bp wider.  
</details>
<br>   

```{r q13_FSCN1_bivalent_promoter, echo = F}
question("What additional histone marks, mark this region? (Select ALL that apply.)",
...
```{r q16_ACTB_enhancer_two, echo = F}
...
```
<br> 
Approximately 20 kb downstream of *CD14* is another enhancer. What histone marks mark this enhancer? (Downstream with respect to the *CD14* orientation.)   

> #### **Optional check**:  
<details><summary> We're referring to the region:</summary>  
<br>
??chr5:140611060-140612601  
</details>
<br>  

```{r q18_cd14_enhancer, echo = F}
...
<details><summary> We're referring to the region:</summary>  
<br>
??chr5:140,147,501-141,605,000   
</details>
<br>  

```{r q19_cd14_near_silencing, echo = F}
question("The expression of what gene family is controlled by this marking?",
...
```
<br>
```{r q20_cd14_near_silencing_two, echo = F}
question("What is the approximate size of the H3K9me3 silenced region? (*Tip2: hold shift and click-and-drag in the brwoser to capture and thereby measure the width of the H3K9me3 domain)",
  answer("250kb"),
  answer("500kb"),
...
> #### **Optional check**:  
<details><summary> Your browser should display:</summary>  
<br>
??chr1:229,418,420-229,446,919  
</details>
<br> 

```{r q21_ACTA1_marking_one, echo = F}
question("Which histone mark most likely mediates repression of *ACTA1* in these cells?",
...
<br>
```{r q22_ACTA1_marking_two, echo = F}
question("Which other observations support that this gene is not active? (Select ALL that apply)",
...
Sample | encoding 1 |  encoding 2 |  encoding 3 | encoding 4  | encoding 5 | encoding 6
:--:|:--:|:--:|:--:|:--:    
H3K9me3 |  b | f | d | b  
H3K27me3 | b  | a | e | c  
H3K4me3 | c | b | f | d  
...
H3K36me3 | f | e | c | a  
DNaseI | f | e | c | a  
RNA-seq minus | f | e | c | a  
RNA-seq plus | f | e | c | a  
...
```{r q23_recognizing_patterns, echo = F}
question("What is the most likely encoding?",
  answer("encoding 1"),
