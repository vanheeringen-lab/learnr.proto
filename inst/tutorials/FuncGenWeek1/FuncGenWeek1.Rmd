...
<center>  
![](images/wk1_3_intro_whatbioinformaticiancsdo.png){width=80%}\    
</center>  
...
![](images/wk1_3_fastq_example3.png)   
</center>  
<br>
...
These fastq files are what we start our processing with:  
...
<br>
2. **Align reads to the genome**: Identify the likely location in the reference genome where the original DNA molecule came from.   
<br>
...
<br>
3. **Filter artefacts and reads aligning to multiple regions**: Identify and remove PCR artefacts and optionally remove reads aligning non-uniquely.   
<br>
...
<br>
<!-- ![](images/wk1_3_seq2science_siebrenspptx.png){width=70%}\    
...
![](images/wk1_3_encode_chipseq_readmapping.png){width=50%}\   
...
### <span style="color: red;">1.3.4 Alternatively: use FAIR data   
