...
#quantificaton chr19
rdsfile <- system.file("extdata", "week2", "prepared_rds", "blueprint_c000s5_gene_quantification_chr19.rds", package = "learnr.proto") # week3 contains chr21 peaks in GRanges objects (week2 worked on chr19)
...
# scores for h3k27me3
# bw_h3k4me3 <- system.file("extdata", "week3",  "C000S5H2_ERX547984_H3K4me3_bwa_GRCh38_20150528_chr21_TSS_20kb.bw", package = "learnr.proto")
bw_h3k4me3 <- "/home/ctoenhake/learnr.proto/inst/extdata/week3/chr21_bw/C000S5H2_ERX547984_H3K4me3_bwa_GRCh38_20150528_chr21_TSS_20_kb.bw"
scores_h3k4me3_tss <- ScoreMatrix(target = bw_h3k4me3, windows = tss_window_with_h3k4me3, type = 'bigWig', strand.aware =TRUE)  
# scores for h3k27me3
# bw_h3k27me3 <- system.file("extdata", "week3",  "C000S5H2_ERX547983_H3K27me3_bwa_GRCh38_20150528_chr21_TSS_20_kb.bw", package = "learnr.proto")
bw_h3k27me3 <- "/home/ctoenhake/learnr.proto/inst/extdata/week3/chr21_bw/C000S5H2_ERX547983_H3K27me3_bwa_GRCh38_20150528_chr21_TSS_20_kb.bw"
scores_h3k27me3_tss <- ScoreMatrix(target = bw_h3k27me3, windows = tss_window_with_h3k4me3, type = 'bigWig', strand.aware =TRUE)  
```
...
`r colorize("Add density plots per quantile with select the correct statment question, wat zie je nu. Is like the fluffmap density with CI", col = "red")` 
