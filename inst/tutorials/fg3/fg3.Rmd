...
### Exercise 16  
ChromHMM analysis was also performed on the monocyte ChIP-seq data you have worked with (ref: [BLUEPRINT secondary analysis](http://dcc.blueprint-epigenome.eu/#/md/secondary_analysis). The following heatmap summarizes the identified spatial combinations of marks:  
