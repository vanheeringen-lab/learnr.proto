...
### 3.5.8 A clustered heatmap with       
...
<br>
If we would have had data of not only the TSS but of the whole gene and of H3K36me3 and H3K9me3, you would also be able to identify transcribed regions and heterochromatinized windows.   
<br>
...
### Exercise 16  
ChromHMM analysis was also performed using the monocyte ChIP-seq data you have worked with. The following heatmap summarizes the different spatial combinations of marks identified:  
...
:--:|:----------:|:----------:|:----------:|:----------:  
A | Heterochromatin | Repressed by polycomb | Repressed by polycomb | Repressed by polycomb       
B | Repressed by polycomb | Heterochromatin | Heterochromatin | Heterochromatin
C | Transcription unit | Enhancer | Transcription unit | Transcription unit
D | Active TSS | Active enhancer | Active enhancer | Enhancer 
E | Active enhancer | Transcription unit |  Enhancer | Active enhancer
F | Enhancer | Active TSS | Active TSS | Active TSS  

<details><summary>***Click here for a hint***</summary> 

- Enhancer is marked by H3K4me1 only.  
- Active enhancer has H3K4me1 and H3K27ac signal.  
- Active TSS has high H3K4me3 & H3K27Ac signal.  
- Transcribed unit is marked by H3K36me3.  
- Repressed Polycomb should have H3K27me3 signal.  
- Heterochromatin should have high H3K9me3 signal.  
</details>  
<br>

```{r q16_recognizing_patterns}
question("The likely annotation is ... ",
         answer("Annotation 1", message = "The 'Heterochromatin' state is marked by H3K9me3 and the 'Repressed by polycomb' by H3K27me3 and not the other way around."),
