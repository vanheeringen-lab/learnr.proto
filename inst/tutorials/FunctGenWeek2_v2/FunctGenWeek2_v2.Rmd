...
txdb_annotation <- readRDS(paste0(datadir, "www/prepared_rds/txdb_annotation_chr19_grangeslist.rds"))
```
...
load(paste0(datadir, "www/prepared_rds/txdb_annotation_chr19_genes_tx_pr_tss_granges.RData"))
```
...
encode_ccres <- readRDS(paste0(datadir, "www/prepared_rds/encode_ccres_chr19.rds"))
...
entrezid_symbols <- readRDS(paste0(datadir, "www/prepared_rds/gene_entrezids_genesymbols_df.rds"))
```
...
monocytes_h3k4me3 <- rtracklayer::import("C000S5H2.ERX547984.H3K4me3.bwa.GRCh38.20150527.chr19.bed", format = "narrowPeak")  
```
<br>
...
> **Exercise 1:**  
Print the head 2 lines of `monocytes_h3k4me3`.  
...
We have the following information about the identified peaks (ref: [MACS2 github](https://github.com/macs3-project/MACS)):  
...
A common first step in genomics data analysis is to make some exploratory plots. We will do so for `monocytes_h3k4me3`.   
<br>
...
monocytes_h3k4me1 <- rtracklayer::import(paste0(datadir, "www/blueprint/bed/C000S5H2.ERX547981.H3K4me1.bwa.GRCh38.broad.20150527.chr19.bed"), format = "broadPeak")
```
...
```{r q2c_explore-solution}
summary(score(monocytes_h3k4me3))
```
...
> *Note*: plotting with the ggplots packages is also possible, as long as we convert the data we are interested to `data.frame` objects by running for example: 
...
```{r q11b_overlap, exercise = T, exercise.setup = "q11_overlap"}
...
```{r q11c_overlap, exercise = T, exercise.setup = "q11_overlap"}
...
<br>
```{r q12_binomtest, exercise = T, exercise.setup = "q11_overlap", exercise.setup = "fraction_promoters"}
...
```{r q13b_anno, exercise = T, exercise.setup = "anno_h3k4me3_prep"}
# make barplot
bp <- ..(..$.., ylab="%")
...
# H3K9me3 
monocytes_h3k9me3 <- rtracklayer::import(paste0(datadir, "www/blueprint/bed/C000S5H2.ERX547982.H3K9me3.bwa.GRCh38.broad.20150527.chr19.bed"), format = "broadPeak")

# H3K27ac 
monocytes_h3k27ac <- rtracklayer::import(paste0(datadir, "www/blueprint/bed/C000S5H2.ERX547980.H3K27ac.bwa.GRCh38.20150527.chr19.bed"), format = "narrowPeak")

# H3K27me3   
monocytes_h3k27me3 <- rtracklayer::import(paste0(datadir, "www/blueprint/bed/C000S5H2.ERX547983.H3K27me3.bwa.GRCh38.broad.20150527.chr19.bed"), format = "broadPeak")

# H3K36me3
monocytes_h3k36me3 <- rtracklayer::import(paste0(datadir, "www/blueprint/bed/C000S5H2.ERX547979.H3K36me3.bwa.GRCh38.broad.20150527.chr19.bed"), format = "broadPeak")
```
...
```{r q15_distance_tss, exercise = T, exercise.setup = "overlap_exercise10"}
