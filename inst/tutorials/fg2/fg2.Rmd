...
```{r addpeaksize, exercise=TRUE, exercise.lines=3, exercise.eval=F, error=T, exercise.setup="prepare-addpeaksize"}
...
```{r plotpeaksize, exercise=TRUE, exercise.lines=5, exercise.eval=F, error=T, exercise.setup="prepare-plotpeaksize"}
...
```{r plotpeaksizelog, exercise=TRUE, exercise.lines=6, exercise.eval=F, error=T, exercise.setup="prepare-plotpeaksize"}
...
```{r summarisewidth, exercise=TRUE, exercise.lines=6, exercise.eval=F, error=T, exercise.setup="prepare-summarisewidth"}
...
```{r summarisewidth-solution, eval=F}
...
```{r plotsummarisewidth, exercise=TRUE, exercise.eval=F, error=T, exercise.setup="prepare-summarisewidth"}
...
```{r q6b_overlap, exercise=TRUE, exercise.eval=F, error=T}
...
```{r q6c_overlap, exercise=TRUE, exercise.eval=F, error=T, exercise.setup="prepare_exercise6"}
...
```{r q6c_overlap_enterfraction, exercise=TRUE, exercise.lines=3, exercise.eval=F, error=T, exercise.setup="prepare_exercise6c"}
# enter the fraction of promoters that are part of the overlap, round to 3 decimal places:  


```

```{r q6c_overlap_enterfraction-solution, eval=F}
...
```{r q6e_plotvenn, exercise=TRUE, exercise.eval=F, error=T, exercise.setup="prepare_exercise6e"}
...
```{r q7a_promfraction_enterfraction, exercise=TRUE, exercise.eval=F, error=T}
...
```{r q8c, exercise=TRUE, exercise.eval=F, error=T, exercise.lines=12}
...
```{r prepare_exercise9, echo=F}
overlap <- findOverlaps(query = monocytes_h3k4me3, subject = promoters_chr19)
```

```{r q9_genesids_overlap, exercise=TRUE, exercise.eval=F, error=T, exercise.setup="prepare_exercise9"}
...
```{r prepare_exercise10a, echo=F}
overlap <- findOverlaps(query = monocytes_h3k4me3, subject = promoters_chr19)
promoters_with_h3k4me3 <- promoters_chr19[subjectHits(overlap)]
```

```{r q10_geneexpression, exercise=TRUE, exercise.eval=F, error=T}
...
```{r q10a_geneexpression, exercise=TRUE, exercise.eval=F, error=T, exercise.setup="prepare_exercise10a"}
...
```{r q10b_plot_genequant, exercise=TRUE, exercise.eval=F, error=T, exercise.setup="prepare_exercise10b"}
...
```{r q10c_plot_genequant, exercise=TRUE, exercise.eval=F, error=T, exercise.setup="prepare_exercise10b"}
...
```{r q10c_plot_genequant-solution, eval=F}
...
```{r q11testing, exercise=TRUE, exercise.eval=F, error=T, exercise.lines=6}
...
```{r q11_H3K27me3_prom, exercise=TRUE, exercise.eval=F, error=T}
...
```{r q12a_bivalent_prom, exercise=TRUE, exercise.eval=F, error=T, exercise.setup="prepare_exercise12"}
...
```{r q12b_bivalent_prom, exercise=TRUE, exercise.eval=F, error=T, exercise.setup="prepare_exercise12b"}
...
```{r q13a_upsetrplot_mark_overlap, exercise=TRUE, exercise.eval=F, error=T, exercise.setup="prepare_exercise13a"}
...
```{r q13b_upsetrplot, exercise=TRUE, exercise.eval=F, error=T, exercise.setup="prepare_exercise13a"}
...
```{r q13c_niceupset, exercise=TRUE, exercise.eval=F, error=T, exercise.setup="prepare_exercise13a"}
# filter monocytes_combinationmatrix for combinations covering at least 100kb
monocytes_combmatrix_filt <- monocytes_combinationmatrix[comb_size(monocytes_combinationmatrix) > 100000]
...
```{r q13d_add_distance_to_tss, exercise=TRUE, exercise.eval=F, error=T, exercise.setup="add_distance_to_tss"}
