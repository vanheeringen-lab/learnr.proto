...
```{r q7a_promfraction, exercise = T, message = F, exercise.setup = "prepare_exercise7"}
# add variable 'promoter_size' variable  
...
```{r q8b_anno_h3k4me3_plot-solution}
data.frame(h3k4me3_features$percentage) %>% 
  ggplot(.)+
...
Sidenote: The background percentage of promoters is slightly lower compared to the output of exercise 7a. This is likely a trade-off has to be made when two or more feature overlap.  
...
# calculate the overlap of H3K27ac peaks with features 
# the object monocytes_h3k27ac has already been loaded for you
h3k27ac_features <- assignChromosomeRegion(h3k27ac_features, proximal.promoter.cutoff=2000, TxDb=txdb, precedence=c("Promoters", "immediateDownstream","fiveUTRs", "threeUTRs", "Exons", "Introns"))
