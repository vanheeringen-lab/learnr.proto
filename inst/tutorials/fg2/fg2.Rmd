...
#### Tutorial specs  
In this tutorial you will have multiple-choice and check-the-box questions like in **fg1** but also complete-the-code exercises. The latter can be evaluated on the computed outcome (e.g a computed p-value), in other cases, the code itself is checked. 
<br>
...
```{r examplecode, exercise=TRUE, exercise.lines=3, exercise.eval=F, error=T}
...
```{r install_genomicranges, eval=F, echo=T}
...
```{r installrtracklayer, eval=F, echo=T}
...
```{r q1_head_h3k4me3, exercise=TRUE, exercise.lines=3, exercise.eval=F, error=T}
# print the head of monocytes_h3k4me3  
...
```{r q2a_exploreh3k4me3, exercise=TRUE, exercise.lines=3, exercise.eval=F, error=T}
...
```{r q2a_exploreh3k4me1, exercise=TRUE, exercise.lines=3, exercise.eval=F, error=T}
...
```{r q2b_widthh3k4me3, exercise=TRUE, exercise.lines=3, exercise.eval=F, error=T}
...
```{r q2b_widthh3k4me1, exercise=TRUE, exercise.lines=3, exercise.eval=F, error=T}
...
```{r monocytesall, exercise=TRUE, exercise.lines=3, exercise.eval=F, error=T}
...
Secondly, before you can make your plot, you have to extract the metadata and write into a a data.frame as GRanges objects are not compatible with ggplot2.  
...
```{r q_extractmetadata, exercise=TRUE, exercise.lines=6, exercise.eval=F, error=T}
# extract metadata 
...
```{r barplotpeakcount, exercise=TRUE, exercise.lines=8, exercise.eval=F, error=T}
...
> **Exercise 4a**: Add the 'peak_size' variable to `monocytes_metadata`. This new variable holds the peak widths.  
Rember, to add new columns to GRanges objects you can use:  
...
```{r addpeaksize, exercise=TRUE, exercise.lines=3, exercise.eval=F, error=T}
...
```{r plotpeaksize, exercise=TRUE, exercise.lines=5, exercise.eval=F, error=T}
...
```{r plotpeaksizelog, exercise=TRUE, exercise.lines=6, exercise.eval=F, error=T}
...
### 2.3.3 Explore peak sizes with dplyr & ggplot  
...
```{r summarizewidth, exercise=TRUE, exercise.lines=6, exercise.eval=F, error=T}
...
```{r plotsummarizewidth, exercise=TRUE, exercise.lines=8, exercise.eval=F, error=T}
...
```{r retrieve_genes_txdb, exercise=TRUE, exercise.lines=7, exercise.eval=F, error=T}
# load the txdb package which holds transcript-based gene models of hg38 genome  
library(TxDb.Hsapiens.UCSC.hg38.knownGene)
txdb <- TxDb.Hsapiens.UCSC.hg38.knownGene 
...
```{r q6a_proms, exercise=TRUE, exercise.lines=3, exercise.eval=F, error=T}
...
```{r q6b_proms, exercise=TRUE, exercise.lines=3, exercise.eval=F, error=T}
...
```{r q6c_overlap, exercise=TRUE, exercise.lines=3, exercise.eval=F, error=T}
...
```{r q6d_overlap, exercise=TRUE, exercise.lines=12, exercise.eval=F, error=T, exercise.setup="prepare_exercise6"}
...
```{r q6d_overlap_enterfraction, exercise=TRUE, exercise.lines=3, exercise.eval=F, error=T, exercise.setup="prepare_exercise6d"}
...
```{r q6e_overlap, exercise=TRUE, exercise.lines=12, exercise.eval=F, error=T, exercise.setup="prepare_exercise6"}
...
```{r q6e_overlap_enterfraction, exercise=TRUE, exercise.lines=3, exercise.eval=F, error=T, exercise.setup= "prepare_exercise6e"}
# enter the fraction of promoters that are part of the overlap, round to 3 decimal places:  
...
```{r q6f_plotvenn, exercise=TRUE, exercise.eval=F, error=T, exercise.setup="prepare_exercise6f"}
...
```{r q7a_promfraction, exercise=TRUE, exercise.eval=F, error=T, exercise.eval=F, error=T}
...
<br>
```{r q7b_binomtest, exercise=TRUE, exercise.eval=F, error=T, exercise.setup="prepare_q7b"}
...
```{r readin_gencode, echo=T, eval=F}
...
```{r prepare_exercise8b, echo=F}
annotation_h3k4me3 <- annotateWithGeneParts(target = monocytes_h3k4me3, feature = gencode_chr19)
```

```{r q8b_genomationoverlap, exercise=TRUE, exercise.eval=F, error=T}
# visualize the output of exercise 8a

```

```{r q8b_genomationoverlap-solution, eval=T, echo=T}
# solution
...
```{r q8c, exercise=TRUE, exercise.eval=F, error=T, exercise.lines=10}


```

```{r q8c_bivalent_mc, echo=T, eval=F}
quiz(caption ="", 
...
```{r q10_H3K27me3_prom, exercise=TRUE, exercise.eval=F, error=T}
...
```{r q11a_bivalent_prom, exercise=TRUE, exercise.eval=F, error=T, exercise.setup="prepare_exercise11"}
...
```{r q11b_bivalent_prom, exercise=TRUE, exercise.eval=F, error=T, exercise.setup="prepare_exercise11b"}
...
```{r q12a_upsetrplot_mark_overlap, exercise=TRUE, exercise.eval=F, error=T, exercise.setup="prepare_exercise12a"}
...
```{r q12b_upsetrplot, exercise=TRUE, exercise.eval=F, error=T, exercise.setup="prepare_exercise12a"}
...
```{r q12c_niceupset, exercise=TRUE, exercise.eval=F, error=T, exercise.setup="prepare_exercise12a"}
# filter monocytes_combinationmatrix for combinations covering at least 100kb
monocytes_combmatrix_filt <- monocytes_combinationmatrix[comb_size(monocytes_combinationmatrix) > 100000]
...
```{r q12d_add_distance_to_tss, exercise=TRUE, exercise.eval=F, error=T, exercise.setup="add_distance_to_tss"}
