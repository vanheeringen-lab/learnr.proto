...
```{r wk3 test chr21, warning=F, eval = F}
library(TxDb.Hsapiens.UCSC.hg38.knownGene)
txdb <- TxDb.Hsapiens.UCSC.hg38.knownGene 
seqlevels(txdb) <- seqlevels0(txdb)
...
## chr21 peaks and quantification for week 3  
...
```{r prepare monocyt data, echo = T, eval = F}
# H3k4me1 
mono_h3k4me1 <- rtracklayer::import("inst/extdata/week3/chr21_bed/C000S5H2.ERX547981.H3K4me1.bwa.GRCh38.broad.20150527.chr21.bed", format = "broadPeak")
# H3K4me3  
mono_h3k4me3 <- rtracklayer::import("inst/extdata/week3/chr21_bed/C000S5H2.ERX547984.H3K4me3.bwa.GRCh38.20150527.chr21.bed", format = "narrowPeak")
# H3K9me3 
mono_h3k9me3 <- rtracklayer::import("inst/extdata/week3/chr21_bed/C000S5H2.ERX547982.H3K9me3.bwa.GRCh38.broad.20150527.chr21.bed", format = "broadPeak")
# H3K27ac 
mono_h3k27ac <- rtracklayer::import("inst/extdata/week3/chr21_bed/C000S5H2.ERX547980.H3K27ac.bwa.GRCh38.20150527.chr21.bed", format = "narrowPeak")
# H3K27me3   
mono_h3k27me3 <- rtracklayer::import("inst/extdata/week3/chr21_bed/C000S5H2.ERX547983.H3K27me3.bwa.GRCh38.broad.20150527.chr21.bed", format = "broadPeak")
# H3K36me3
mono_h3k36me3 <- rtracklayer::import("inst/extdata/week3/chr21_bed/C000S5H2.ERX547979.H3K36me3.bwa.GRCh38.broad.20150527.chr21.bed", format = "broadPeak")
# create list
mono_list  <- GRangesList(mono_h3k4me1, mono_h3k4me3, mono_h3k9me3, mono_h3k27ac, mono_h3k27me3, mono_h3k36me3)
# add names to each element in the list
names(mono_list) <- c("h3k4me1", "h3k4me3", "h3k9me3", "h3k27ac", "h3k27me3", "h3k36me3")
...
This was downaloaded from http://dcc.blueprint-epigenome.eu/#/experiments/ERX157053 --> "Transcription quantification (Genes)" file.  
...
```{r save prepare monocyt data, echo = T, eval = F}
save(mono_h3k4me1, mono_h3k4me3, mono_h3k9me3, mono_h3k27ac, mono_h3k27me3, mono_h3k36me3, mono_list, quantification_chr21, file =  "inst/extdata/week3.RData")
```
