...
- complete and chr19 limited .bed files are stored on cn45: `/scratch/ctoenhake/data/fg1_r_data/blueprint/chip_bed`  
...
- File "C000S5B1.gene_quantification.rsem_grape2_crg.GRCh38.20150622.results" 
  ...
  + is stored on cn45: `/scratch/ctoenhake/data/fg1_r_data/blueprint/quant/C000S5B1.gene_quantification.rsem_grape2_crg.GRCh38.20150622.results`.   
...
# week 3
the raw bigwig data are removed from the tutorial.   
...
- used a bit of a work-around to get these bigwigs on passer:  
    + copy resulting *.chr19.bw to the web accessible directory that I also used for the trackhubs `/molbiol/mb03-sdb1/mbdata/ctoenhake/edu/monocytes_data_bigwigs_chr19only`  
